...
target.forEach(element => observer.observe(element));
  ...
  width:'100vw'
       ...
       <h2 className={visible? `${styles.subheaderAnimation}` : `${styles.subheader}`}>Integrity</h2>
       ...
       </div> <HashLink to={'/#section2'} className={styles.links} smooth={true}>
       <Arrow />
       </HashLink>
      </section>
       ...
       <section id={'section2'} className={styles.section}>  
        <div className={styles.pWrapper}> 
        <h2 className={visible? `${styles.subheaderAnimation}` : `${styles.subheader}`}>Professionalism</h2>
       ...
       At Wangui Gathere we aim to provide comprehensive legal services geared at achieving our clients’ business, personal and professional goals.
        ...
        <HashLink to={'/#section5'} className={styles.links} smooth={true}>
       <Arrow />
       </HashLink>
       </section>
       ...
       <section id={'section3'} className={styles.section}>
        <div className={styles.pWrapper}> 
        <h2 className={visible? `${styles.subheaderAnimation}` : `${styles.subheader}`}>Efficency</h2>
       ...
       </div><HashLink to={'/#section1'} className={styles.links} smooth={true}>
       <ArrowUp />
       </HashLink>
       </section>
