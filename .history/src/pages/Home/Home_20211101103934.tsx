    ...
    <div className={styles.wrapper}>
      ...
      <main className={styles.main}>
        <section id={"section1"} className={styles.section}>
          <img src="/assets/1.webp" alt="" className={styles.img} /> <div className={styles.pWrapper}>
        ...
        <section id={"section2"} className={styles.section}>
          <img src="/assets/2.webp" alt="" className={styles.img} /><div className={styles.pWrapper}>
        ...
        <section id={"section3"} className={styles.section}>
          <img src="/assets/3.webp" alt="" className={styles.img} /> <div className={styles.pWrapper}>
