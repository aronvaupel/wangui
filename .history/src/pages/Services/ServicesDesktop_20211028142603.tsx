      ...
      >
        <section id={"section6"} className={styles.section}>
          <div className={styles.pWrapper}>
            ...
            <HashLink to={"/#section7"} className={styles.links} smooth={true}>
              <Arrow />
            </HashLink>
          </div>
        </section>
        ...
        <section id={"section7"} className={styles.section}>
          <div className={styles.pWrapper}>
            ...
            <HashLink to={"/#section8"} className={styles.links} smooth={true}>
              <Arrow />
            </HashLink>
          </div>
        </section>
        ...
        <section id={"section8"} className={styles.section}>
          <div className={styles.pWrapper}>
            ...
            <HashLink to={"/#section10"} className={styles.links} smooth={true}>
              <Arrow />
            </HashLink>
          </div>
        </section>
        ...
        <section id={"section9"} className={styles.section}>
          <div className={styles.pWrapper}>
            ...
            <HashLink to={"/#section6"} className={styles.links} smooth={true}>
              <ArrowUp />
            </HashLink>
          </div>
        </section>
