  ...
  const team = [
    {
      ...
      text: "Wangui Gathere is the managing partner at the firm. She holds a Bachelor of Law degree from the University of Nairobi and a Post Graduate Diploma in Law from the Kenya School of Law. She heads the Litigation and Commercial law department at the firm.For Wangui every case she takes up is personal and not just another case file. She takes the trust her clients put in her personally and puts herself into every case. Besides practicing law, Wangui is big on advocacy and is an ambassador at the International Federation of Psoriasis Associations(IFPA).",
    },
    {
      firstName: "Lenah",
      familyName: "Moenga",
