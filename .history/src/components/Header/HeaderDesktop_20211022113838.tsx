...
const HeaderStateMap = {
    home: <HeaderHome {...(isActive ? active : inactive)} />,
    team: <HeaderTeam {...(isActive ? active : inactive)} />,
    services: <HeaderServices {...(isActive ? active : inactive)} />,
    location: <HeaderLocation {...(isActive ? active : inactive)} />,
